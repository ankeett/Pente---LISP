...
(define-project :name :project1
  :modules (list (make-instance 'module :name "main.lsp")
                 (make-instance 'module :name "Board.lsp")
                 (make-instance 'module :name "ComputerPlayer.lsp")
                 (make-instance 'module :name "HumanPlayer.lsp")
                 (make-instance 'module :name "Round.lsp"))
  :projects nil
  :libraries nil
  :editable-files nil
